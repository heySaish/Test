...
import { Download, Github, Shield, ArrowRight, Activity, Cpu, Layers, Terminal, ChevronRight } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Link
                  to="/downloads"
                  className="flex items-center gap-2.5 px-6 py-3.5 rounded-xl font-mono text-sm font-semibold text-black bg-emerald-400 hover:bg-emerald-300 transition-all shadow-lg shadow-emerald-500/25 active:scale-95"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-2.5 px-6 py-3.5 rounded-xl font-mono text-sm font-semibold text-zinc-200 bg-zinc-900/90 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-700 transition-all active:scale-95"
                >
                ...
                <Link
                  to="/voidsu"
                  className="flex items-center gap-1.5 px-4 py-3 rounded-xl font-mono text-sm text-cyan-400 hover:text-cyan-300 hover:bg-cyan-500/10 transition-all"
                >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          ...
          <p className="text-xs sm:text-sm text-zinc-400">
            Explore the specialized pages dedicated to Void Kernel subsystem mechanics.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link
            to="/features"
            className="terminal-card p-6 rounded-2xl border border-zinc-800 hover:border-emerald-500/40 transition-all group space-y-4"
          >
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center">
              <Cpu className="w-5 h-5 text-emerald-400" />
            </div>
            <h3 className="text-base font-bold font-sans text-white group-hover:text-emerald-300">
              Kernel Features
            </h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              MGLRU page reclaim, BBRplus TCP congestion, EAS scheduler tuning, and SUSFS mount unmounting.
            </p>
            <div className="flex items-center gap-1 text-xs font-mono text-emerald-400 pt-2">
          ...
          <Link
            to="/voidsu"
            className="terminal-card p-6 rounded-2xl border border-zinc-800 hover:border-cyan-500/40 transition-all group space-y-4"
          >
            <div className="w-10 h-10 rounded-xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center">
              <Shield className="w-5 h-5 text-cyan-400" />
            </div>
            <h3 className="text-base font-bold font-sans text-white group-hover:text-cyan-300">
              VoidSU Ecosystem
            </h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Companion manager designed for direct in-kernel privilege elevation without userspace su binaries.
            </p>
            <div className="flex items-center gap-1 text-xs font-mono text-cyan-400 pt-2">
              <span>Discover VoidSU</span>
              <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>
          ...
          <Link
            to="/dashboard"
            className="terminal-card p-6 rounded-2xl border border-zinc-800 hover:border-purple-500/40 transition-all group space-y-4"
          >
            <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center">
              <Activity className="w-5 h-5 text-purple-400" />
            </div>
            <h3 className="text-base font-bold font-sans text-white group-hover:text-purple-300">
              Technical Dashboard
            </h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Live system load gauges, Snapdragon 720G Kryo core topologies, and interactive sysctl tuners.
            </p>
            <div className="flex items-center gap-1 text-xs font-mono text-purple-400 pt-2">
